...
class TiQuestion14bViewController: UIViewController {
    ...
    @objc func playvideo() {
        guard let filePath = Bundle.main.path(forResource: "TiQuestion14b", ofType: "mp4") else {
            print("動画が見つからない")
            return
        }
    ...
    @objc func goToNextScreen() {
        ...
        print("次の画面")
        // 次の画面に遷移
        let nextViewController = TiQuestion15bViewController()
