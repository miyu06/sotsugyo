...
class TiBar8ViewController: UIViewController {
    ...
    @objc func playvideo() {
        guard let filePath = Bundle.main.path(forResource: "TiBar8", ofType: "mp4") else {
            print("動画が見つからない")
            return
        }
    ...
    @objc func goToNextScreen() {
        ...
        print("次の画面")
        // 次の画面に遷移
        let nextViewController = TiBar9ViewController()
